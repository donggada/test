...
// 세션: 연결정보를 저장하는 내장객체
// 		페이지 상관없이 값을 서버에서 저장유지
// 		보안상 중요한 데이터 저장유지, 로그인 인증
// 쿠키:페이지 상관없이 값을 사용자 컴퓨터에 저장유지
// 	  :서버에 부하를 줄이고자 사용  ,보안성 중요하지 않는 데이터 저장


//쿠키값 클라이언트 -> 서버요청 가져옴 => 서버에 요청정보 저정 request
Cookie cookies[]=request.getCookies();
//여러개 쿠키 값중에 "cook 이름을 가진 쿠키값 찾기
//쿠키값이 있으면
if(!(cookies ==null)){
